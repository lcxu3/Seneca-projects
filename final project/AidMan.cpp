...
namespace sdds
{
        ...
        do {
            ...
            if (option == 0) {
                ...
                if (numberItemsArray > sdds_max_num_items) {
                    ...
                    int sku;
                    char content[143] = "1- Perishable\n2- Non-Perishable\n-----------------\n ";
                    Menu tempMenu(content, 3);
                    int n = tempMenu.run();
                    if (n == 0) {
                        cout << "Aborted\n";
                        return;
                    ...
                    sku = allItems[numberItemsArray]->readSku(cin);
                    if (search(sku) != 1) {
    ...
    void AidMan::add() {
        if (allItems[numberItemsArray - 1] != nullptr) {
            allItems[numberItemsArray - 1]->read(cin);
        }
        save();
        deallocate();
    };
